      ...
      <div className="react-countdown-container">
        <span className="react-countdown-box">
          <span className="react-countdown-element">
              ...
              <span className="react-countdown-time-text">{countDown.days === 1 ? langFormat[lang].Day : langFormat[lang].Days }</span>
          </span>
        </span>
        ...
        <span className="react-countdown-box">
          <span className="react-countdown-element">
            ...
            <span className="react-countdown-time-text">{ langFormat[lang].Hours }</span>
          </span>
        </span>
        ...
        <span className="react-countdown-box">
          <span className="react-countdown-element">
            ...
            <span className="react-countdown-time-text">{ langFormat[lang].Min }</span>
          </span>
        </span>
        ...
        <span className="react-countdown-box">
          <span className="react-countdown-element">
            ...
            <span className="react-countdown-time-text">{ langFormat[lang].Sec }</span>
          </span>
        </span>
      </div>
    );
